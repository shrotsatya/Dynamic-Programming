...
class Knapsack {
    public static int findKnapsackRec(int capacity, int[] weights, int[] values, int n, int[][] dp) {
        // Base case
        if (n == 0 || capacity == 0)
            return 0;
        ...
        // Otherwise, we solve it for the new combination and save the results in the
        // memory
